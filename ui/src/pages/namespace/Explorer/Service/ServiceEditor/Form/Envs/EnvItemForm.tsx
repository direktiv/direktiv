...
type EnvItemFormProps = {
  item?: EnvVarSchemaType;
  onAdd?: (value: EnvVarSchemaType) => void;
  onUpdate?: (value: EnvVarSchemaType) => void;
  onDelete?: () => void;
};
...
export const EnvItemForm: FC<EnvItemFormProps> = ({
  ...
  const [state, setState] = useState<EnvVarSchemaType>(item || emptyItem);

  const handleChange = (object: Partial<EnvVarSchemaType>) => {
