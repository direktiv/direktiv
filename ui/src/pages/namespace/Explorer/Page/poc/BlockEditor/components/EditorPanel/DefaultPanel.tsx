...
export const DefaultPanel = () => {
  ...
  return (
    <div
      ...
      className="overflow-y-clip border-gray-5 dark:border-gray-dark-5 max-lg:border-b lg:border-r"
    >
      <div className="w-full rounded rounded-b-none bg-gray-1 p-5 dark:bg-gray-dark-1">
