...
describe("required fields", () => {
  describe("string input field", () => {
    ...
    test("submits the form when a required string input field is filled in", async () => {
      await act(async () => {
        render(
          <PageCompiler
            setPage={setPage}
  ...
  describe("number input field", () => {
    ...
    test("submits the form when a required number input field is filled in", async () => {
      await act(async () => {
        render(
          <PageCompiler
            setPage={setPage}
  ...
  describe("date input field", () => {
    ...
    test("submits the form when a required date input field is filled in", async () => {
      await act(async () => {
        render(
          <PageCompiler
            setPage={setPage}
  ...
  describe("select field", () => {
    test("shows an error when a required ‚ field is missing a value", async () => {
      await act(async () => {
        render(
          <PageCompiler
            setPage={setPage}
    ...
    test("submits the form when a required select field is filled in", async () => {
      await act(async () => {
        render(
          <PageCompiler
            setPage={setPage}
  ...
  describe("checkbox field", () => {
    ...
    test("submits the form when a required checkbox field is filled in", async () => {
      await act(async () => {
        render(
          <PageCompiler
            setPage={setPage}
  ...
  describe("textarea field", () => {
    ...
    test("submits the form when a required textarea field is filled in", async () => {
      await act(async () => {
        render(
          <PageCompiler
            setPage={setPage}
