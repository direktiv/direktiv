  ...
  ({ className, ...props }, ref) => (
    <textarea
      className={twMergeClsx(
        "flex h-20 w-full rounded-md border bg-transparent px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
