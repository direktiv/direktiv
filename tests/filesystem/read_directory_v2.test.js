...
describe('Test filesystem tree read operations', () => {
	...
	helpers.itShouldCreateYamlFileV2(it, expect, namespace, '/','foo.yaml', helpers.dummyWorkflow('foo'))
	helpers.itShouldCreateYamlFileV2(it, expect, namespace, '/dir1','foo11.yaml', helpers.dummyWorkflow('foo11'))
	helpers.itShouldCreateYamlFileV2(it, expect, namespace, '/dir1','foo12.yaml', helpers.dummyWorkflow('foo12'))
