...
describe('Test workflow variable operations', () => {
	...
	it(`should fail invalid name`, async () => {
		const workflowVarResponse = await request(common.config.getDirektivHost()).put(`/api/namespaces/${ namespaceName }/vars/hel$$o`)
	...
	it(`should set plain text variable`, async () => {
		const workflowVarResponse = await request(common.config.getDirektivHost()).put(`/api/namespaces/${ namespaceName }/vars/plain`)
	...
	it(`should set json variable`, async () => {
		const workflowVarResponse = await request(common.config.getDirektivHost()).put(`/api/namespaces/${ namespaceName }/vars/json`)
			.set('Content-Type', 'application/json')
			.send(jdata)
	...
	it(`should set binary variable`, async () => {
		...
		const workflowVarResponse = await request(common.config.getDirektivHost()).put(`/api/namespaces/${ namespaceName }/vars/binary`)
	...
	it(`should list all variable`, async () => {
		const workflowVarResponse = await request(common.config.getDirektivHost()).get(`/api/namespaces/${ namespaceName }/vars`)
	...
	it(`should get json variable`, async () => {
		const workflowVarResponse = await request(common.config.getDirektivHost()).get(`/api/namespaces/${ namespaceName }/vars/json`)
	...
	it(`should get text variable`, async () => {
		const workflowVarResponse = await request(common.config.getDirektivHost()).get(`/api/namespaces/${ namespaceName }/vars/plain`)
	...
	it(`should get binary variable`, async () => {
		const workflowVarResponse = await request(common.config.getDirektivHost()).get(`/api/namespaces/${ namespaceName }/vars/binary`)
	...
	it(`should delete one variable`, async () => {
		const workflowVarResponse = await request(common.config.getDirektivHost()).delete(`/api/namespaces/${ namespaceName }/vars/json`)

		expect(workflowVarResponse.statusCode).toEqual(200)
	})

	it(`should have less variables`, async () => {
		const workflowVarListResponse = await request(common.config.getDirektivHost()).get(`/api/namespaces/${ namespaceName }/vars`)
