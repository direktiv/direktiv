...
describe('Test workflow variable operations', () => {
    ...
    it(`should get text variable`, async () => {
        var workflowVarResponse = await request(common.config.getDirektivHost()).get(`/api/namespaces/${namespaceName}/vars/plain`)
    ...
    it(`should get binary variable`, async () => {
        var workflowVarResponse = await request(common.config.getDirektivHost()).get(`/api/namespaces/${namespaceName}/vars/binary`)
