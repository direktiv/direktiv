...
describe('Test workflow variable operations', () => {
	...
	it(`should fail invalid name`, async () => {
		const workflowVarResponse = await request(config.getDirektivHost()).put(`/api/namespaces/${ namespace }/vars/hel$$o`)
	...
	it(`should set plain text variable`, async () => {
		const workflowVarResponse = await request(config.getDirektivHost()).put(`/api/namespaces/${ namespace }/vars/plain`)
	...
	it(`should set json variable`, async () => {
		const workflowVarResponse = await request(config.getDirektivHost()).put(`/api/namespaces/${ namespace }/vars/json`)
			.set('Content-Type', 'application/json')
			.send(jdata)
	...
	it(`should list all variable`, async () => {
		const workflowVarResponse = await request(config.getDirektivHost()).get(`/api/namespaces/${ namespace }/vars`)
	...
	it(`should get json variable`, async () => {
		const workflowVarResponse = await request(config.getDirektivHost()).get(`/api/namespaces/${ namespace }/vars/json`)
	...
	it(`should get text variable`, async () => {
		const workflowVarResponse = await request(config.getDirektivHost()).get(`/api/namespaces/${ namespace }/vars/plain`)
	...
	it(`should get binary variable`, async () => {
		const workflowVarResponse = await request(config.getDirektivHost()).get(`/api/namespaces/${ namespace }/vars/binary`)
	...
	it(`should delete one variable`, async () => {
		const workflowVarResponse = await request(config.getDirektivHost()).delete(`/api/namespaces/${ namespace }/vars/json`)

		expect(workflowVarResponse.statusCode).toEqual(200)
	})

	it(`should have less variables`, async () => {
		const workflowVarListResponse = await request(config.getDirektivHost()).get(`/api/namespaces/${ namespace }/vars`)
