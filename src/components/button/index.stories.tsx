...
SynchronousButton.args = {
  ...
  tooltip:
    "Once clicked, will be set to disabled until onClick function has finished.",
...
SynchronousButton.story = {
  parameters: {
    docs: {
      description: {
        story:
          "When setting asyncDisable to true, buttons will be set to disabled when the onClick event is fired. Disabled will automatically be set back to false when all promises in the onClick callback are resolved. In this example a 2000ms timeout promise is executed on the onClick event.",
      },
    },
  },
};
