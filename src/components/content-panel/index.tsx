 ...
 */
function ContentPanel({ grow = false, ...props }: ContentPanelProps) {
  return (
    <div
      {...props}
      style={{
      ...
      className={`content-panel-parent opaque ${
...
export function ContentPanelTitle({
  ...props
}: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <FlexBox
      {...props}
      className={`content-panel-title ${
        props.className ? props.className : ""
      }`}
    />
  );
...
export function ContentPanelTitleIcon({
  ...props
}: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      {...props}
      className={`content-panel-title-icon ${
        props.className ? props.className : ""
      }`}
    />
  );
...
export function ContentPanelBody({
  ...
  return (
    <div
      {...props}
      className={`content-panel-body ${props.className ? props.className : ""}`}
    />
  );
}

export function ContentPanelFooter({
  ...props
}: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      {...props}
      className={`content-panel-footer ${
        props.className ? props.className : ""
      }`}
    />
  );
