    ...
    <FlexBox className="content-col col">
      <FlexBox className="breadcrumbs-row">
        {namespace ? (
          <Breadcrumbs
            namespace={namespace}
            additionalChildren={breadcrumbChildren}
          />
        ) : null}
      </FlexBox>
        ...
        {namespaces !== null ? (
          <Routes>
              ...
              element={
                <div className="message-container">
                  <p className="no-workspace-message">
                    You are not a part of any namespaces! Create a namespace to
                    continue using Direktiv.
                  </p>
                </div>
              }
            />
            ...
            <Route
              ...
              element={<Monitoring namespace={namespace} />}
            />
            {/* <Route path="/n/:namespace/builder" element={<WorkflowBuilder namespace={namespace}/>}/> */}
            <Route
              path="/n/:namespace/instances"
              element={<InstancesPage namespace={namespace} />}
            />
            <Route
              path="/n/:namespace/instances/:id"
              element={<InstancePageWrapper namespace={namespace} />}
            />
            ...
            <Route
              ...
              element={<NamespaceServices namespace={namespace} />}
            />
            <Route
              path="/n/:namespace/services/:service"
              element={<NamespaceRevisions namespace={namespace} />}
            />
            <Route
              path="/n/:namespace/services/:service/:revision"
              element={<PodPanel namespace={namespace} />}
            />
...
function MainLayout(props) {
  ...
  const { data, err, createNamespace, createMirrorNamespace, deleteNamespace } =
    useNamespaces(Config.url, false, akey);
...
function ResponsiveHeaderBar(props) {
  ...
  return (
    ...
    >
      <div style={{ minWidth: "50px", maxWidth: "50px" }}></div>
      <FlexBox>
        <img
          src={SmallLogo}
          alt="Direktiv"
