...
function NamespaceRevisionDetails(props) {
  ...
  const { revisionDetails, pods, err } = useNamespaceServiceRevision(
    Config.url,
    namespace,
    service,
    revision,
        ...
        <FlexBox col style={{ backgroundColor: "#223848" }}>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    alignItems: "center",
                    cursor: "pointer",
                    backgroundColor: tab === obj.name ? "#223848" : "#355166",
                    padding: "5px",
                    maxWidth: "150px",
                    gap: "3px",
                  }}
                >
                  <VscServerEnvironment
                    style={{ fill: tab === obj.name ? "white" : "#b5b5b5" }}
                  />
                  <span
                    style={{
          ...
          >
            ...
            >
              {version
                ? tab.split(
                    `workflow-${version}-${service}-${revision}-deployment-`
                  )
                : ""}
              {namespace
                ? tab.split(
                    `${namespace}-${service}-${revision}-deployment-`
                  )[1]
