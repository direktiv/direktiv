...
function NamespaceServices(props) {
  ...
  useEffect(() => {
    async function getcfg() {
      await getNamespaceConfig().then((response) =>
        ...
        {!dontDelete && !traffic ? (
          <>
            {latest ? (
              ...
              >
                <Modal
                  title="Delete namespace service"
                  escapeToCancel
                  modalStyle={{
                    maxWidth: "400px",
                    width: "400px",
            ...
            >
              ...
              >
                <div style={{ textAlign: "center" }}>
                  ...
                  <div>
                    The pods will be recreated the next time an action is
                    executed that requires this service.
                  </div>
                  <br />
