...
const CommonSchemaDefinitionConsumeEvent = {
  ...
  properties: {
    ...
    context: {
      ...
      title: "Context",
      description:
        "Key value pairs for CloudEvent context values that must match.",
  ...
  items: {
    ...
    properties: {
      ...
      scope: {
        title: "Scope",
        description:
          "Scope used to select variable. Defaults to 'instance', but can be 'workflow' or 'namespace'.",
        type: "string",
      ...
      as: {
        title: "As",
        description:
          "Set the filename of the file. The default is the same as the key.",
        type: "string",
      },
      type: {
        title: "Type",
        description:
          "How to treat the file. Options include 'plain', 'base64', 'tar', 'tar.gz'.",
        type: "string",
      },
    },
  },
...
export const CommonSchemaDefinitionStateFields = {
  transform: {
    ...
    properties: {
      selectionType: {
        enum: ["JQ Query", "Key Value", "YAML", "Javascript"],
        default: "JQ Query",
      },
    },
    allOf: [
  ...
  items: {
    ...
    properties: {
      ...
      multiplier: {
        ...
        title: "Multiplier",
        description:
          "Value by which the delay is multiplied after each attempt.",
      },
      codes: {
        type: "array",
        title: "Codes",
...
const CommonSchemaDefinitionAction = {
  ...
  properties: {
    ...
    secrets: {
      ...
      title: "Secrets",
      description:
        "List of secrets to temporarily add to the state data under .secrets before running the input jq command.",
      items: {
        type: "string",
      },
    },
...
export const StateSchemaError = {
  ...
  properties: {
    ...
    args: {
      ...
      title: "Arguments",
      description:
        "A list of jq commands to generate arguments for substitution in the message format string.",
    },
    ...CommonSchemaDefinitionStateFields,
  },
};
...
export const StateSchemaEventXor = {
  ...
  properties: {
    events: {
      ...
      title: "Events",
      description:
        "Events to consume, and what to do based on which event was received.",
      items: {
        type: "object",
        required: ["event"],
        properties: {
    ...
    event: {
      ...
      properties: {
        ...
        datacontenttype: {
          ...
          description:
            "An RFC 2046 string specifying the payload content type.",
        },
        data: {
          ...CommonSchemaDefinitionStateFields.transform,
          title: "Data",
...
export const StateSchemaValidate = {
  ...
  properties: {
    subject: {
      ...
      title: "Subject",
      description:
        "jq command to select the subject of the schema validation. Defaults to '.' if unspecified.",
    },
    schema: {
      type: "string",
      title: "Schema",
...
export const StateSchemaAction = {
  ...
  properties: {
    ...
    async: {
      title: "Async",
      description:
        "If workflow execution can continue without waiting for the action to return.",
      type: "boolean",
    },
    timeout: CommonSchemaDefinitionTimeout,
    ...CommonSchemaDefinitionStateFields,
...
export const StateSchemaSwitch = {
  ...
  properties: {
    conditions: {
      ...
      title: "Conditions",
      description:
        "Conditions to evaluate and determine which state to transition to next.",
      items: {
        type: "object",
        required: ["condition"],
        properties: {
          condition: {
            ...
            title: "Condition",
            description:
              "jq command evaluated against state data. True if results are not empty.",
          },
          transform: CommonSchemaDefinitionStateFields.transform,
        },
      },
...
const SpecialSchemaError = {
  ...
  description:
    "Thrown erros will be compared against each Error in order until it finds a match.",
  items: {
    required: ["error"],
    properties: {
      error: {
...
export const SpecialSchemaEventsAndStart = {
  ...
  properties: {
    ...
    lifespan: {
      ...
      title: "Lifespan",
      description:
        "Maximum duration an event can be stored before being discarded while waiting for other events (ISO8601).",
      examples: ["PT5S", "PT5M", "PT5H"],
    },
    correlate: {
      type: "array",
      title: "Correlate",
      description:
        "Context keys that must exist on every event and have matching values to be grouped together.",
      items: {
        type: "string",
      },
    },
...
const SpecialSchemaStart = {
  ...
  properties: {
    type: {
      enum: ["default", "scheduled", "event", "eventsAnd", "eventsXor"],
      default: "default",
      title: "Start Type",
    },
  },
...
export function GenerateFunctionSchemaWithEnum(
  ...
  if (namespaceServices) {
    if (namespaceServices.length > 0) {
      ...
      uiSchema["knative-namespace"]["service"]["ui:placeholder"] =
        "Select Service";
    } else {
  ...
  if (globalServices) {
    if (globalServices.length > 0) {
      ...
      uiSchema["knative-global"]["service"]["ui:placeholder"] =
        "Select Service";
    } else {
