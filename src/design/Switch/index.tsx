...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={clsx(
      ...
      "focus:ring-gray-7 focus:ring-offset-gray-1 data-[state=unchecked]:bg-gray-6 data-[state=checked]:bg-gray-12",
      "focus:ring-gray-dark-7 dark:focus:ring-offset-gray-dark-1 dark:data-[state=unchecked]:bg-gray-dark-6 dark:data-[state=checked]:bg-gray-dark-12",
      className
    )}
    {...props}
    ref={ref}
