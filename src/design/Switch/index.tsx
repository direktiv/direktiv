...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={clsx(
      ...
      "focus:ring-offset-gray-1 focus:ring-gray-7 data-[state=unchecked]:bg-gray-6 data-[state=checked]:bg-gray-12",
      "dark:focus:ring-offset-gray-dark-1 focus:ring-gray-dark-7 dark:data-[state=unchecked]:bg-gray-dark-6 dark:data-[state=checked]:bg-gray-dark-12",
      className
    )}
    {...props}
    ref={ref}
