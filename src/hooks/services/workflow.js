...
/* 
    ...
    - apikey
*/
export const useDirektivWorkflowServiceRevision = (
  url,
  namespace,
  path,
  service,
...
/* 
    ...
    - apikey
*/
export const useDirektivWorkflowService = (
  url,
  namespace,
  path,
  service,
...
*/
export const useDirektivWorkflowServices = (
  url,
  stream,
  namespace,
  path,
  ...
  React.useEffect(() => {
    if (stream) {
      setPathString(
        url && namespace && path
          ? `${url}functions/namespaces/${namespace}/tree${SanitizePath(
              path
            )}?op=services`
          : null
      );
