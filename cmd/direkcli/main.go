...
func Execute() {
	...
	// Namespace command
	// namespace.NamespaceCmd.AddCommand(namespaceListCmd)
	// namespace.NamespaceCmd.AddCommand(namespaceCreateCmd)
	// namespace.NamespaceCmd.AddCommand(namespaceDeleteCmd)
	// namespace.NamespaceCmd.AddCommand(namespaceSendEventCmd)
