...
func (sq *ServicesQuery) GroupBy(field string, fields ...string) *ServicesGroupBy {
	group := &ServicesGroupBy{config: sq.config}
...
func (sq *ServicesQuery) Select(fields ...string) *ServicesSelect {
	...
	return &ServicesSelect{ServicesQuery: sq}
}
...
func (sq *ServicesQuery) sqlAll(ctx context.Context) ([]*Services, error) {
	var (
		nodes = []*Services{}
		_spec = sq.querySpec()
	)
...
func (sgb *ServicesGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ServicesGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ServicesGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{services.Label}
	default:
		err = fmt.Errorf("ent: ServicesGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ServicesGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ServicesGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ServicesGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{services.Label}
	default:
		err = fmt.Errorf("ent: ServicesGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ServicesGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ServicesGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ServicesGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{services.Label}
	default:
		err = fmt.Errorf("ent: ServicesGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ServicesGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ServicesGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ServicesGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{services.Label}
	default:
		err = fmt.Errorf("ent: ServicesGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ServicesSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ServicesSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ServicesSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{services.Label}
	default:
		err = fmt.Errorf("ent: ServicesSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ServicesSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ServicesSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ServicesSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{services.Label}
	default:
		err = fmt.Errorf("ent: ServicesSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ServicesSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ServicesSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ServicesSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{services.Label}
	default:
		err = fmt.Errorf("ent: ServicesSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ServicesSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ServicesSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ServicesSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{services.Label}
	default:
		err = fmt.Errorf("ent: ServicesSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
