...
func TestAddFolder(t *testing.T) {
	...
	//check if folders are autoCreated missing Folders
	body = GetSecrets(ip, namespace, "a/")
	bodyNames = BodyToList(body)
	expected = []string{"a/", "a/b/"}
	assert.Equal(t, bodyNames, expected)
	...
	DeleteSecretOrFolder(ip, namespace, "/")
}
...
func DeleteSecretOrFolder(ip string, namespace string, name string) error {
...
func GetSecrets(ip string, namespace string, folder string) AutoGenerated {
...
func BodyToList(body AutoGenerated) []string {
