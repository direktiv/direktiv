...
func (engine *engine) SetInstanceFailed(ctx context.Context, im *instanceMemory, err error) error {
	...
	engine.logger.Errorf(ctx, im.instance.Instance.NamespaceID, im.instance.GetAttributes(recipient.Namespace), "Workflow %s canceled due to instance %s failed", im.instance.Instance.CalledAs, im.GetInstanceID())
	engine.logger.Errorf(ctx, im.GetInstanceID(), im.GetAttributes(), "Workflow %s canceled due to instance %s failed", im.instance.Instance.CalledAs, im.GetInstanceID())
