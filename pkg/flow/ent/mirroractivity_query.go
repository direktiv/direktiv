...
func (maq *MirrorActivityQuery) GroupBy(field string, fields ...string) *MirrorActivityGroupBy {
	group := &MirrorActivityGroupBy{config: maq.config}
...
func (maq *MirrorActivityQuery) Select(fields ...string) *MirrorActivitySelect {
	...
	return &MirrorActivitySelect{MirrorActivityQuery: maq}
}
...
func (maq *MirrorActivityQuery) sqlAll(ctx context.Context) ([]*MirrorActivity, error) {
	var (
...
func (magb *MirrorActivityGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (magb *MirrorActivityGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(magb.fields) > 1 {
		return nil, errors.New("ent: MirrorActivityGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := magb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (magb *MirrorActivityGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (magb *MirrorActivityGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{mirroractivity.Label}
	default:
		err = fmt.Errorf("ent: MirrorActivityGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (magb *MirrorActivityGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (magb *MirrorActivityGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(magb.fields) > 1 {
		return nil, errors.New("ent: MirrorActivityGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := magb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (magb *MirrorActivityGroupBy) IntsX(ctx context.Context) []int {
	v, err := magb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (magb *MirrorActivityGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{mirroractivity.Label}
	default:
		err = fmt.Errorf("ent: MirrorActivityGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (magb *MirrorActivityGroupBy) IntX(ctx context.Context) int {
	v, err := magb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (magb *MirrorActivityGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(magb.fields) > 1 {
		return nil, errors.New("ent: MirrorActivityGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := magb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (magb *MirrorActivityGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (magb *MirrorActivityGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{mirroractivity.Label}
	default:
		err = fmt.Errorf("ent: MirrorActivityGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (magb *MirrorActivityGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (magb *MirrorActivityGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(magb.fields) > 1 {
		return nil, errors.New("ent: MirrorActivityGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := magb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (magb *MirrorActivityGroupBy) BoolsX(ctx context.Context) []bool {
...
// It is only allowed when executing a group-by query with one field.
func (magb *MirrorActivityGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{mirroractivity.Label}
	default:
		err = fmt.Errorf("ent: MirrorActivityGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (magb *MirrorActivityGroupBy) BoolX(ctx context.Context) bool {
	v, err := magb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
// ScanX is like Scan, but panics if an error occurs.
func (mas *MirrorActivitySelect) ScanX(ctx context.Context, v interface{}) {
...
func (mas *MirrorActivitySelect) Strings(ctx context.Context) ([]string, error) {
	if len(mas.fields) > 1 {
		return nil, errors.New("ent: MirrorActivitySelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := mas.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (mas *MirrorActivitySelect) StringsX(ctx context.Context) []string {
...
func (mas *MirrorActivitySelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{mirroractivity.Label}
	default:
		err = fmt.Errorf("ent: MirrorActivitySelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (mas *MirrorActivitySelect) StringX(ctx context.Context) string {
...
func (mas *MirrorActivitySelect) Ints(ctx context.Context) ([]int, error) {
	if len(mas.fields) > 1 {
		return nil, errors.New("ent: MirrorActivitySelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := mas.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (mas *MirrorActivitySelect) IntsX(ctx context.Context) []int {
	v, err := mas.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (mas *MirrorActivitySelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{mirroractivity.Label}
	default:
		err = fmt.Errorf("ent: MirrorActivitySelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (mas *MirrorActivitySelect) IntX(ctx context.Context) int {
	v, err := mas.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (mas *MirrorActivitySelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(mas.fields) > 1 {
		return nil, errors.New("ent: MirrorActivitySelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := mas.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (mas *MirrorActivitySelect) Float64sX(ctx context.Context) []float64 {
...
func (mas *MirrorActivitySelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{mirroractivity.Label}
	default:
		err = fmt.Errorf("ent: MirrorActivitySelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (mas *MirrorActivitySelect) Float64X(ctx context.Context) float64 {
...
func (mas *MirrorActivitySelect) Bools(ctx context.Context) ([]bool, error) {
	if len(mas.fields) > 1 {
		return nil, errors.New("ent: MirrorActivitySelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := mas.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (mas *MirrorActivitySelect) BoolsX(ctx context.Context) []bool {
	v, err := mas.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (mas *MirrorActivitySelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{mirroractivity.Label}
	default:
		err = fmt.Errorf("ent: MirrorActivitySelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (mas *MirrorActivitySelect) BoolX(ctx context.Context) bool {
	v, err := mas.Bool(ctx)
	if err != nil {
		panic(err)
	}
