...
var file_pkg_flow_grpc_util_proto_rawDesc = []byte{
	...
	0x6b, 0x74, 0x69, 0x76, 0x5f, 0x66, 0x6c, 0x6f, 0x77, 0x22, 0x35, 0x0a, 0x09, 0x4a, 0x51, 0x52,
	...
	0x22, 0x50, 0x0a, 0x0a, 0x4a, 0x51, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14,
	...
	0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x73, 0x22, 0xdd, 0x09, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04,
...
var file_pkg_flow_grpc_util_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_pkg_flow_grpc_util_proto_goTypes = []interface{}{
	...
	(*State)(nil),        // 2: direktiv_flow.State
	(*Outcomes)(nil),     // 3: direktiv_flow.Outcomes
	(*MeanOutcomes)(nil), // 4: direktiv_flow.MeanOutcomes
	nil,                  // 5: direktiv_flow.State.InvokersEntry
	nil,                  // 6: direktiv_flow.State.InvokersRepresentationEntry
	nil,                  // 7: direktiv_flow.State.UnhandledErrorsEntry
	nil,                  // 8: direktiv_flow.State.UnhandledErrorsRepresentationEntry
	nil,                  // 9: direktiv_flow.Outcomes.TransitionsEntry
	nil,                  // 10: direktiv_flow.MeanOutcomes.TransitionsEntry
}
var file_pkg_flow_grpc_util_proto_depIdxs = []int32{
	5,  // 0: direktiv_flow.State.invokers:type_name -> direktiv_flow.State.InvokersEntry
	6,  // 1: direktiv_flow.State.invokersRepresentation:type_name -> direktiv_flow.State.InvokersRepresentationEntry
	7,  // 2: direktiv_flow.State.unhandledErrors:type_name -> direktiv_flow.State.UnhandledErrorsEntry
	8,  // 3: direktiv_flow.State.unhandledErrorsRepresentation:type_name -> direktiv_flow.State.UnhandledErrorsRepresentationEntry
	3,  // 4: direktiv_flow.State.outcomes:type_name -> direktiv_flow.Outcomes
	4,  // 5: direktiv_flow.State.meanOutcomes:type_name -> direktiv_flow.MeanOutcomes
	9,  // 6: direktiv_flow.Outcomes.transitions:type_name -> direktiv_flow.Outcomes.TransitionsEntry
	10, // 7: direktiv_flow.MeanOutcomes.transitions:type_name -> direktiv_flow.MeanOutcomes.TransitionsEntry
