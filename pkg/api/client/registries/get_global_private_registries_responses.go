...
func (o *GetGlobalPrivateRegistriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetGlobalPrivateRegistriesOK()
...
func NewGetGlobalPrivateRegistriesOK() *GetGlobalPrivateRegistriesOK {
	return &GetGlobalPrivateRegistriesOK{}
}
...
func (o *GetGlobalPrivateRegistriesOK) Error() string {
	return fmt.Sprintf("[GET /api/functions/registries/private][%d] getGlobalPrivateRegistriesOK ", 200)
}

func (o *GetGlobalPrivateRegistriesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
