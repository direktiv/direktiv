...
func (o *WatchNamespaceServiceRevisionListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchNamespaceServiceRevisionListOK()
...
func (o *WatchNamespaceServiceRevisionListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
