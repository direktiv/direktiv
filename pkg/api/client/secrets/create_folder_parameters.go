...
// WithFolder adds the folder to the create folder params
func (o *CreateFolderParams) WithFolder(folder string) *CreateFolderParams {
	o.SetFolder(folder)
	return o
}

// SetFolder adds the folder to the create folder params
func (o *CreateFolderParams) SetFolder(folder string) {
	o.Folder = folder
}

// WithNamespace adds the namespace to the create folder params
func (o *CreateFolderParams) WithNamespace(namespace string) *CreateFolderParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the create folder params
func (o *CreateFolderParams) SetNamespace(namespace string) {
