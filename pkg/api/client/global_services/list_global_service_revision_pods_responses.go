...
func (o *ListGlobalServiceRevisionPodsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListGlobalServiceRevisionPodsOK()
...
func NewListGlobalServiceRevisionPodsOK() *ListGlobalServiceRevisionPodsOK {
	return &ListGlobalServiceRevisionPodsOK{}
}
...
func (o *ListGlobalServiceRevisionPodsOK) Error() string {
	return fmt.Sprintf("[GET /api/functions/{serviceName}/revisions/{revisionGeneration}/pods][%d] listGlobalServiceRevisionPodsOK ", 200)
}

func (o *ListGlobalServiceRevisionPodsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
