...
func (o *WatchGlobalServiceRevisionListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewWatchGlobalServiceRevisionListOK()
...
func NewWatchGlobalServiceRevisionListOK() *WatchGlobalServiceRevisionListOK {
	return &WatchGlobalServiceRevisionListOK{}
}
...
func (o *WatchGlobalServiceRevisionListOK) Error() string {
	return fmt.Sprintf("[GET /api/functions/{serviceName}/revisions][%d] watchGlobalServiceRevisionListOK ", 200)
}

func (o *WatchGlobalServiceRevisionListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
