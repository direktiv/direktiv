...
var file_pkg_isolates_grpc_protocol_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xf2, 0x02, 0x0a, 0x0f, 0x49, 0x73, 0x6f, 0x6c,
...
var file_pkg_isolates_grpc_protocol_proto_goTypes = []interface{}{
	...
	(*GetIsolateResponse)(nil),   // 6: grpc.GetIsolateResponse
}
var file_pkg_isolates_grpc_protocol_proto_depIdxs = []int32{
	...
	4, // 5: grpc.IsolatesService.UpdateIsolate:output_type -> google.protobuf.Empty
	4, // 6: grpc.IsolatesService.CreateIsolate:output_type -> google.protobuf.Empty
	4, // 7: grpc.IsolatesService.DeleteIsolates:output_type -> google.protobuf.Empty
	5, // 8: grpc.IsolatesService.ListIsolates:output_type -> grpc.ListIsolatesResponse
	6, // 9: grpc.IsolatesService.GetIsolate:output_type -> grpc.GetIsolateResponse
