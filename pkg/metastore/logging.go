...
type LogEntry struct {
	...
	Activity  string    `json:"activity"`         // Activity identifier
	Route     string    `json:"route"`            // gateway route identifier
	...
	CalledAs  string    `json:"calledAs"`         // calledAs
	Branch    string    `json:"branch,omitempty"` // Branch
}
